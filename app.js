...
/* =================================================================
   MERGED FEATURES — chat customization, songs, reply drops,
   streak shields, monthly recap.  All inline below.
   Uses the existing top-of-file: state, db, auth, $, $$,
   escapeHtml, showToast, todayKey, uploadToCloudinary, extractHashtags.
   ================================================================= */

// Firestore namespace alias so the feature blocks can call F.doc(...) etc.
const F = {
    collection, doc, setDoc, getDoc, updateDoc, deleteDoc,
    query, where, getDocs, addDoc, serverTimestamp, onSnapshot,
    orderBy, limit, arrayUnion, arrayRemove, increment,
